...
*/
(function(d){"function"===typeof define&&define.amd?define(["jquery","http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net"],function(g){return d(g,window,document)}):"object"===typeof exports?module.exports=function(g,h){g||(g=window);if(!h||!h.fn.dataTable)h=require("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net")(g,h).$;return d(h,g,g.document)}:d(jQuery,window,document)})(function(d,g,h,k){var j=d.fn.dataTable,l=0,i=function(b,a){if(!(this instanceof i))throw"FixedHeader must be initialised with the 'new' keyword.";!0===a&&(a={});b=new j.Api(b);this.c=d.extend(!0,
...
b,this.update());return this.c.headerOffset},footerOffset:function(b){b!==k&&(this.c.footerOffset=b,this.update());return this.c.footerOffset},update:function(){this._positions();this._scroll(!0)},_constructor:function(){var b=this,a=this.s.dt;d(g).on("scroll"+this.s.namespace,function(){b._scroll()}).on("resize"+this.s.namespace,function(){b.s.position.windowHeight=d(g).height();b.update()});a.on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/column-reorder.dt.dtfc column-visibility.dt.dtfc draw.dt.dtfc",function(){b.update()});a.on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/destroy.dtfc",
...
i;d.fn.DataTable.FixedHeader=i;d(h).on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/init.dt.dtb",function(b,a){if("dt"===b.namespace){var e=a.oInit.fixedHeader||j.defaults.fixedHeader;e&&!a._fixedHeader&&new i(a,e)}});j.Api.register("fixedHeader()",function(){});j.Api.register("fixedHeader.adjust()",function(){return this.iterator("table",function(b){(b=b._fixedHeader)&&b.update()})});j.Api.register("fixedHeader.enable()",function(b){return this.iterator("table",function(a){(a=a._fixedHeader)&&a.enable(b!==k?b:!0)})});j.Api.register("fixedHeader.disable()",
