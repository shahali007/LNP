...
*/
(function(e){"function"===typeof define&&define.amd?define(["jquery","http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net"],function(i){return e(i,window,document)}):"object"===typeof exports?module.exports=function(i,l){i||(i=window);if(!l||!l.fn.dataTable)l=require("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net")(i,l).$;return e(l,i,i.document)}:e(jQuery,window,document)})(function(e,i,l,j){function q(c){var a=c.settings()[0]._select.selector;e(c.table().body()).off("mousedown.dtSelect",a).off("mouseup.dtSelect",a).off("click.dtSelect",a);e("body").off("click.dtSelect")}
...
f,"row",d)):"column"===d?(d=c.cell(p).index().column,s(b,c,f,"column",d)):"cell"===d&&(d=c.cell(p).index(),s(b,c,f,"cell",d)),f._select_lastCell=g)}});e("body").on("click.dtSelect",function(a){b._select.blurable&&!e(a.target).parents().filter(c.table().container()).length&&(e(a.target).parents("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/div.DTE").length||n(b,!0))})}function k(c,a,b,d){if(!d||c.flatten().length)b.unshift(c),e(c.table().node()).triggerHandler(a+".dt",b)}function u(c){var a=c.settings()[0];if(a._select.info&&a.aanFeatures.i){var b=
...
j}),d=b.cells({selected:!0}).eq(0).map(function(a){var d=b.row(a.row).id(!0);return d?{row:d,column:a.column}:j}).filter(function(b){return b!==j});b.one("draw.dt.dtSelect",function(){b.rows(a).select();d.any()&&d.each(function(a){b.cells(a.row,a.column).select()})})});b.on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/draw.dtSelect.dt select.dtSelect.dt deselect.dtSelect.dt",function(){u(b)});b.on("destroy.dtSelect",function(){q(b);b.off(".dtSelect")})}var d=new g.Api(a);q(d);"api"!==c&&t(d);k(new g.Api(a),"selectStyle",[c])})});i("select.selector()",
...
c[b]],!0)});return this});m("cells().deselect()","cell().deselect()",function(){var c=this;this.iterator("cell",function(a,b,c){b=a.aoData[b];b._selected_cells[c]=!1;b.anCells&&!a.aoColumns[c]._select_selected&&e(b.anCells[c]).removeClass(a._select.className)});this.iterator("table",function(a,b){k(c,"deselect",["cell",c[b]],!0)});return this});e.extend(g.ext.buttons,{selected:{text:o("selected","Selected"),className:"buttons-selected",init:function(c){var a=this;c.on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/draw.dt.DT select.dt.DT deselect.dt.DT",
function(){var b=a.rows({selected:!0}).any()||a.columns({selected:!0}).any()||a.cells({selected:!0}).any();a.enable(b)});this.disable()}},selectedSingle:{text:o("selectedSingle","Selected single"),className:"buttons-selected-single",init:function(c){var a=this;c.on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/draw.dt.DT select.dt.DT deselect.dt.DT",function(){var b=c.rows({selected:!0}).flatten().length+c.columns({selected:!0}).flatten().length+c.cells({selected:!0}).flatten().length;a.enable(1===b)});this.disable()}},selectAll:{text:o("selectAll",
"Select all"),className:"buttons-select-all",action:function(){this[this.select.items()+"s"]().select()}},selectNone:{text:o("selectNone","Deselect all"),className:"buttons-select-none",action:function(){n(this.settings()[0],!0)}}});e.each(["Row","Column","Cell"],function(c,a){var b=a.toLowerCase();g.ext.buttons["select"+a+"s"]={text:o("select"+a+"s","Select "+b+"s"),className:"buttons-select-"+b+"s",action:function(){this.select.items(b)},init:function(a){var c=this;a.on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/selectItems.dt.DT",function(a,
