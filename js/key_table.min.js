...
*/
(function(e){"function"===typeof define&&define.amd?define(["jquery","http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net"],function(k){return e(k,window,document)}):"object"===typeof exports?module.exports=function(k,j){k||(k=window);if(!j||!j.fn.dataTable)j=require("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net")(k,j).$;return e(j,k,k.document)}:e(jQuery,window,document)})(function(e,k,j,n){var g=e.fn.dataTable,l=function(a,b){if(!g.versionCheck||!g.versionCheck("1.10.8"))throw"KeyTable requires DataTables 1.10.8 or newer";this.c=e.extend(!0,{},g.defaults.keyTable,
