...
*/
(function(e){"function"===typeof define&&define.amd?define(["jquery","http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net"],function(n){return e(n,window,document)}):"object"===typeof exports?module.exports=function(n,o){n||(n=window);if(!o||!o.fn.dataTable)o=require("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net")(n,o).$;return e(o,n,n.document)}:e(jQuery,window,document)})(function(e,n,o,m){var j=e.fn.dataTable,s=0,t=0,k=j.ext.buttons,l=function(a,b){!0===b&&(b={});e.isArray(b)&&(b={buttons:b});this.c=e.extend(!0,{},l.defaults,b);b.buttons&&(this.c.buttons=b.buttons);
...
(d=f.buttonLiner);if(a.available&&!a.available(g,a))return!1;var i=e("<"+c.tag+"/>").addClass(c.className).attr("tabindex",this.s.dt.settings()[0].iTabIndex).attr("aria-controls",this.s.dt.table().node().id).on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/click.dtb",function(b){b.preventDefault();!i.hasClass(c.disabled)&&a.action&&a.action.call(g.button(i),b,g,i,a);i.blur()}).on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/keyup.dtb",function(b){b.keyCode===13&&!i.hasClass(c.disabled)&&a.action&&a.action.call(g.button(i),b,g,i,a)});d.tag?i.append(e("<"+d.tag+"/>").html(h(a.text)).addClass(d.className)):
...
/*! Print */
(function(d){"function"===typeof define&&define.amd?define(["jquery","http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net","datatables.net-buttons"],function(c){return d(c,window,document)}):"object"===typeof exports?module.exports=function(c,a){c||(c=window);if(!a||!a.fn.dataTable)a=require("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net")(c,a).$;a.fn.dataTable.Buttons||require("datatables.net-buttons")(c,a);return d(a,c,c.document)}:d(jQuery,window,document)})(function(d,c,a){var h=d.fn.dataTable,f=a.createElement("a");h.ext.buttons.print={className:"buttons-print",
...
/*! Flash */
(function(f){"function"===typeof define&&define.amd?define(["jquery","http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net","datatables.net-buttons"],function(h){return f(h,window,document)}):"object"===typeof exports?module.exports=function(h,g){h||(h=window);if(!g||!g.fn.dataTable)g=require("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net")(h,g).$;g.fn.dataTable.Buttons||require("datatables.net-buttons")(h,g);return f(g,h,h.document)}:f(jQuery,window,document)})(function(f,h,g,m){var i=f.fn.dataTable,e={version:"1.0.4-TableTools2",clients:{},moviePath:"",nextId:1,
...
fieldSeparator:",",fieldBoundary:'"',exportOptions:{},title:"*",filename:"*",extension:".csv",header:!0,footer:!1};i.Buttons.swfPath="flashExport.swf"/*tpa=http://cdn.datatables.net/buttons/1.0.0/swf/flashExport.swf*/;i.Api.register("buttons.resize()",function(){f.each(e.clients,function(a,b){b.domElement!==m&&b.domElement.parentNode&&b.positionElement()})});i.ext.buttons.copyFlash=f.extend({},l,{className:"buttons-copy buttons-flash",text:function(a){return a.i18n("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/buttons.copy","Copy")},action:function(a,b,d,c){c._fromFlash&&
(a=c._flash,c=p(b,c),a.setAction("copy"),k(a,c.str),b.buttons.info(b.i18n("buttons.copyTitle","Copy to clipboard"),b.i18n("buttons.copyInfo",{_:"Copied %d rows to clipboard",1:"Copied 1 row to clipboard"},c.rows),3E3))},fieldSeparator:"\t",fieldBoundary:""});i.ext.buttons.csvFlash=f.extend({},l,{className:"buttons-csv buttons-flash",text:function(a){return a.i18n("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/buttons.csv","CSV")},action:function(a,b,d,c){a=c._flash;b=p(b,c);a.setAction("csv");a.setFileName(n(c));k(a,b.str)},escapeChar:'"'});
...
"&amp;").replace(/[\x00-\x1F\x7F-\x9F]/g,""))+"</t></is></c>")}return"<row>"+b.join("")+"</row>"};c.header&&(a+=e(b.header));for(var f=0,g=b.body.length;f<g;f++)a+=e(b.body[f]);c.footer&&(a+=e(b.footer));d.setAction("excel");d.setFileName(n(c));k(d,a)},extension:".xlsx"});i.ext.buttons.pdfFlash=f.extend({},l,{className:"buttons-pdf buttons-flash",text:function(a){return a.i18n("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/buttons.pdf","PDF")},action:function(a,b,d,c){var a=c._flash,d=b.buttons.exportData(c.exportOptions),e=b.table().node().offsetWidth,
...
/*! HTML5 */
(function(g){"function"===typeof define&&define.amd?define(["jquery","http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net","datatables.net-buttons"],function(d){return g(d,window,document)}):"object"===typeof exports?module.exports=function(d,f){d||(d=window);if(!f||!f.fn.dataTable)f=require("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net")(d,f).$;f.fn.dataTable.Buttons||require("datatables.net-buttons")(d,f);return g(f,d,d.document)}:g(jQuery,window,document)})(function(g,d,f,k){var l=g.fn.dataTable,j;if("undefined"!==typeof navigator&&/MSIE [1-9]\./.test(navigator.userAgent))j=
...
f=RegExp(d,"g"),g=b.escapeChar!==k?b.escapeChar:"\\",i=function(a){for(var b="",c=0,e=a.length;c<e;c++)0<c&&(b+=h),b+=d?d+(""+a[c]).replace(f,g+d)+d:a[c];return b},n=b.header?i(c.header)+e:"",j=b.footer?e+i(c.footer):"",l=[],m=0,o=c.body.length;m<o;m++)l.push(i(c.body[m]));return{str:n+l.join(e)+j,rows:l.length}},C=function(){return-1!==navigator.userAgent.indexOf("Safari")&&-1===navigator.userAgent.indexOf("Chrome")&&-1===navigator.userAgent.indexOf("Opera")},m={"http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/_rels/.rels":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">\t<Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/xl/workbook.xml"/></Relationships>',
"http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/xl/_rels/workbook.xml.rels":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">\t<Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/worksheets/sheet1.xml"/></Relationships>',"[Content_Types].xml":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">\t<Default Extension="xml" ContentType="application/xml"/>\t<Default Extension="rels" ContentType="application/vnd.openxmlformats-package.relationships+xml"/>\t<Default Extension="jpeg" ContentType="image/jpeg"/>\t<Override PartName="http://followtechnique.com/xl/workbook.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet.main+xml"/>\t<Override PartName="http://followtechnique.com/xl/worksheets/sheet1.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml"/></Types>',
"http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/xl/workbook.xml":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">\t<fileVersion appName="xl" lastEdited="5" lowestEdited="5" rupBuild="24816"/>\t<workbookPr showInkAnnotation="0" autoCompressPictures="0"/>\t<bookViews>\t\t<workbookView xWindow="0" yWindow="0" windowWidth="25600" windowHeight="19020" tabRatio="500"/>\t</bookViews>\t<sheets>\t\t<sheet name="Sheet1" sheetId="1" r:id="rId1"/>\t</sheets></workbook>',
"http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/xl/worksheets/sheet1.xml":'<?xml version="1.0" encoding="UTF-8" standalone="yes"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:mc="http://schemas.openxmlformats.org/markup-compatibility/2006" mc:Ignorable="x14ac" xmlns:x14ac="http://schemas.microsoft.com/office/spreadsheetml/2009/9/ac">\t<sheetData>\t\t__DATA__\t</sheetData></worksheet>'};l.ext.buttons.copyHtml5={className:"buttons-copy buttons-html5",
text:function(a){return a.i18n("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/buttons.copy","Copy")},action:function(a,b,d,c){a=B(b,c);c=a.str;d=g("<div/>").css({height:1,width:1,overflow:"hidden",position:"fixed",top:0,left:0});c=g("<textarea readonly/>").val(c).appendTo(d);if(f.queryCommandSupported("copy")){d.appendTo("body");c[0].focus();c[0].select();try{f.execCommand("copy");d.remove();b.buttons.info(b.i18n("buttons.copyTitle","Copy to clipboard"),b.i18n("buttons.copySuccess",{1:"Copied one row to clipboard",_:"Copied %d rows to clipboard"},
...
function(a){27===a.keyCode&&j()}).on("copy.buttons-copy cut.buttons-copy",function(){j()})},exportOptions:{},fieldSeparator:"\t",fieldBoundary:"",header:!0,footer:!1};l.ext.buttons.csvHtml5={className:"buttons-csv buttons-html5",available:function(){return d.FileReader!==k&&d.Blob},text:function(a){return a.i18n("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/buttons.csv","CSV")},action:function(a,b,d,c){u(c);a=B(b,c).str;b=c.charset;!1!==b?(b||(b=f.characterSet||f.charset),b&&(b=";charset="+b)):b="";j(new Blob([a],{type:"text/csv"+b}),t(c))},
...
m["[Content_Types].xml"]);e.file(".rels",m["http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/_rels/.rels"]);f.file("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/workbook.xml",m["http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/xl/workbook.xml"]);h.file("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/workbook.xml.rels",m["http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/xl/_rels/workbook.xml.rels"]);g.file("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/sheet1.xml",m["http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/xl/worksheets/sheet1.xml"].replace("__DATA__",a));j(b.generate({type:"blob"}),t(c))},filename:"*",extension:".xlsx",exportOptions:{},header:!0,footer:!1};l.ext.buttons.pdfHtml5={className:"buttons-pdf buttons-html5",available:function(){return d.FileReader!==k&&d.pdfMake},text:function(a){return a.i18n("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/buttons.pdf",
...
/*! Colvis */
(function(g){"function"===typeof define&&define.amd?define(["jquery","http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net","datatables.net-buttons"],function(d){return g(d,window,document)}):"object"===typeof exports?module.exports=function(d,e){d||(d=window);if(!e||!e.fn.dataTable)e=require("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net")(d,e).$;e.fn.dataTable.Buttons||require("datatables.net-buttons")(d,e);return g(e,d,d.document)}:g(jQuery,window,document)})(function(g,d,e,h){d=g.fn.dataTable;g.extend(d.ext.buttons,{colvis:function(a,b){return{extend:"collection",
