...
*/
(function(e){"function"===typeof define&&define.amd?define(["jquery","http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net"],function(k){return e(k,window,document)}):"object"===typeof exports?module.exports=function(k,i){k||(k=window);if(!i||!i.fn.dataTable)i=require("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net")(k,i).$;return e(i,k,k.document)}:e(jQuery,window,document)})(function(e,k,i,r){var j=e.fn.dataTable,o=0,g=function(c,b){if(!j.versionCheck||!j.versionCheck("1.10.8"))throw"Warning: AutoFill requires DataTables 1.10.8 or greater";this.c=e.extend(!0,{},j.defaults.autoFill,
g.defaults,b);this.s={dt:new j.Api(c),namespace:".autoFill"+o++,scroll:{},scrollInterval:null,handle:{height:0,width:0}};this.dom={handle:e('<div class="dt-autofill-handle"/>'),select:{top:e('<div class="dt-autofill-select top"/>'),right:e('<div class="dt-autofill-select right"/>'),bottom:e('<div class="dt-autofill-select bottom"/>'),left:e('<div class="dt-autofill-select left"/>')},background:e('<div class="dt-autofill-background"/>'),list:e('<div class="dt-autofill-list panel panel-warning panel-bordered"><div class="dt-autofill-header panel-heading mb-10"><h6 class="panel-title text-semibold">Please confirm your action</h6></div>'+this.s.dt.i18n("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/autoFill.info",
...
'Increment / decrement each cell by: <input type="number" value="1">')},execute:function(c,b,a){for(var c=1*b[0][0].data,a=1*e("input",a).val(),d=0,f=b.length;d<f;d++)for(var l=0,h=b[d].length;l<h;l++)b[d][l].set=c,c+=a}},fill:{available:function(){return!0},option:function(c,b){return c.i18n("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/autoFill.fill","Fill all cells with <span class='text-semibold ml-10'>"+b[0][0].data+"</span>")},execute:function(c,b){for(var a=b[0][0].data,d=0,f=b.length;d<f;d++)for(var e=0,h=b[d].length;e<h;e++)b[d][e].set=a}},fillHorizontal:{available:function(c,
