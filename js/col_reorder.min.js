...
f;b++)m(a.aoHeader[b],c,e);if(null!==a.aoFooter){b=0;for(f=a.aoFooter.length;b<f;b++)m(a.aoFooter[b],c,e)}(new d.fn.dataTable.Api(a)).rows().invalidate();b=0;for(f=h;b<f;b++)d(a.aoColumns[b].nTh).off("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/click.DT"),this.oApi._fnSortAttachListener(a,a.aoColumns[b].nTh,b);d(a.oInstance).trigger("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/column-reorder.dt",[a,{from:c,to:e,mapping:l,iFrom:c,iTo:e,aiInvertMapping:l}])}};var g=function(a,c){var e=(new d.fn.dataTable.Api(a)).settings()[0];if(e._colReorder)return e._colReorder;!0===c&&(c={});var b=
