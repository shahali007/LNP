...
*/
(function(n,p){var o=function(e,k){var h=function(d,a){if(!k.versionCheck||!k.versionCheck("1.10.1"))throw"DataTables Responsive requires DataTables 1.10.1 or newer";this.s={dt:new k.Api(d),columns:[]};this.s.dt.settings()[0].responsive||(a&&"string"===typeof a.details&&(a.details={type:a.details}),this.c=e.extend(!0,{},h.defaults,k.defaults.responsive,a),d.responsive=this,this._constructor())};h.prototype={_constructor:function(){var d=this,a=this.s.dt;a.settings()[0]._responsive=this;e(n).on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/resize.dtr orientationchange.dtr",
a.settings()[0].oApi._fnThrottle(function(){d._resize()}));a.on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/destroy.dtr",function(){e(n).off("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/resize.dtr orientationchange.dtr draw.dtr")});this.c.breakpoints.sort(function(a,d){return a.width<d.width?1:a.width>d.width?-1:0});this._classLogic();this._resizeAuto();var c=this.c.details;c.type&&(d._detailsInit(),this._detailsVis(),a.on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/column-visibility.dtr",function(){d._detailsVis()}),a.on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/draw.dtr",function(){a.rows({page:"current"}).iterator("row",function(b,c){var f=a.row(c);if(f.child.isShown()){var i=
