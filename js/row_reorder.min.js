...
*/
(function(e){"function"===typeof define&&define.amd?define(["jquery","http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net"],function(f){return e(f,window,document)}):"object"===typeof exports?module.exports=function(f,g){f||(f=window);if(!g||!g.fn.dataTable)g=require("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/datatables.net")(f,g).$;return e(g,f,f.document)}:e(jQuery,window,document)})(function(e,f,g){var h=e.fn.dataTable,i=function(b,a){if(!h.versionCheck||!h.versionCheck("1.10.8"))throw"DataTables RowReorder requires DataTables 1.10.8 or newer";this.c=e.extend(!0,{},h.defaults.rowReorder,
...
i;e(g).on("http://followtechnique.com/themes/bird_v1/theme/js/datatables/extensions/init.dt.dtr",function(b,a){if("dt"===b.namespace){var d=a.oInit.rowReorder,c=h.defaults.rowReorder;if(d||c)c=e.extend({},d,c),!1!==d&&new i(a,c)}});return i});
